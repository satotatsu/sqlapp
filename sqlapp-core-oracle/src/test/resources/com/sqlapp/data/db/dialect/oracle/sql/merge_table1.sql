MERGE "tableA"
USING (
	SELECT /*cola*/0 AS "cola", /*colb*/'' AS "colb", CURRENT_TIMESTAMP AS "created_at", COALESCE(/*updated_at*/CURRENT_TIMESTAMP, CURRENT_TIMESTAMP) AS "updated_at", 0 AS "lock_version"
	FROM DUAL
) AS "_target"
