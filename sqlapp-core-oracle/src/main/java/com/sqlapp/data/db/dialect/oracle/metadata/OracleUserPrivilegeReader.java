...
public class OracleUserPrivilegeReader extends UserPrivilegeReader {

	protected OracleUserPrivilegeReader(Dialect dialect) {
		super(dialect);
	}
	...
	protected SqlNode getSqlSqlNode(ProductVersionInfo productVersionInfo) {
		return getSqlNodeCache().getString("userPrivileges.sql");
	}
