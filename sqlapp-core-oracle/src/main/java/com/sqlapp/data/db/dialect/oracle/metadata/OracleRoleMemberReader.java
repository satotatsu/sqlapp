...
public class OracleRoleMemberReader extends RoleMemberReader {

	protected OracleRoleMemberReader(Dialect dialect) {
		super(dialect);
	}
	...
	protected RoleMember createRoleMember(ExResultSet rs) throws SQLException {
		...
		obj.setDefault("YES".equalsIgnoreCase(getString(rs, "DEFAULT_ROLE")));
		return obj;
	}
}
