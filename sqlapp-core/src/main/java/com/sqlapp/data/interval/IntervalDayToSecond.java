...
public class IntervalDayToSecond extends Interval {
	...
	private IntervalDayToSecond(int years, int months, int days, int hours, int minutes, int seconds) {
		super(years, months, days, hours, minutes, seconds, 0);
	}
	...
	public IntervalDayToSecond(int days, int hours, int minutes, int seconds) {
		super(0, 0, days, hours, minutes, seconds, 0);
	}
	...
	public static IntervalDayToSecond toDayToSecondType(final Interval interval) {
		...
		IntervalDayToSecond result = new IntervalDayToSecond(interval.getDays(), interval.getHours(),
				interval.getMinutes(), interval.getSeconds(), interval.getNanos());
