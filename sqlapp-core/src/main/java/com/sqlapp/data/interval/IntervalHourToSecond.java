...
public class IntervalHourToSecond extends IntervalDayToSecond {
	...
	public IntervalHourToSecond(int hours, int minutes, int seconds) {
		super(0, hours, minutes, seconds, 0);
	}
	...
	public static IntervalHourToSecond toHourToSecondType(final Interval interval) {
		...
		IntervalHourToSecond result = new IntervalHourToSecond(interval.getHoursFull(), interval.getMinutes(),
