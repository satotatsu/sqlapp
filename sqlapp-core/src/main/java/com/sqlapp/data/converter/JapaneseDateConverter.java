...
/**
 * java.time.JapaneseDate converter 複数の日付フォーマットをサポート
 */
public class JapaneseDateConverter extends AbstractJava8DateConverter<JapaneseDate, JapaneseDateConverter>
		implements Supplier<JapaneseDate> {
	...
	private final Pattern PATTERN = Pattern.compile(
			"(?<g>明治|明|M|大正|大|T|昭和|昭|S|平成|平|H|令和|令|R)(?<y>[1-9]?[0-9])(年|/|-)(?<m>[0-1]?[0-9])(月|/|-)(?<d>[0-3]?[0-9])(日)?");
