...
/**
 * java.time.OffsetTime converter 複数の日付フォーマットをサポート
 */
public class OffsetTimeConverter extends AbstractJava8OffsetConverter<OffsetTime, OffsetTimeConverter>
		implements Supplier<OffsetTime> {
	...
	public OffsetTime convertObject(Object value) {
		...
		if (value instanceof OffsetTime) {
			...
			return toOffsetTime(toZonedDateTime(clock.instant()));
