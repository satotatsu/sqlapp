 ...
 *
 */
public class CidrType extends AbstractNoSizeType<CidrType>{
	 ...
	 */
	public CidrType(){
		this(DataType.CIDR.getTypeName());
	}
	
	protected CidrType(String dataTypeName){
		this.setDataType(DataType.CIDR);
