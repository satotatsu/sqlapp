...
public abstract class TableLinkReader extends AbstractSchemaObjectReader<TableLink>{

	protected TableLinkReader(Dialect dialect) {
		super(dialect);
	}

	@Override
	protected SchemaObjectProperties getSchemaObjectProperties(){
		return SchemaObjectProperties.TABLE_LINKS;
	}
	...
	protected String getNameLabel(){
		return DbObjects.TABLE_LINK.getCamelCaseNameLabel();
	}
