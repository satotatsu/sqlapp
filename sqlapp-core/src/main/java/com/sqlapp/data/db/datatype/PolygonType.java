...
public class PolygonType extends AbstractNoSizeType<PolygonType>{
	 ...
	 * コンバータ
	 */
	protected Converter<Polygon> converter=Converters.getDefault().getConverter(Polygon.class);
	/**
	 * コンストラクタ
	 */
	public PolygonType(){
	...
	protected PolygonType(String dataTypeName){
		this.setDataType(DataType.POLYGON);
