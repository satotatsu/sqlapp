 ...
 * 
 */
public abstract class AbstractCreateTemporaryTableFactory<S extends AbstractSqlBuilder<?>>
	...
	public List<SqlOperation> createSql(final Table table) {
		...
		addSql(sqlList, builder, SqlType.CREATE_TEMPORARY, table);
	...
	protected void addCreateObject(final Table obj, final S builder) {
		...
		builder.declare().local().temporary().table();
		builder.space()._add(
