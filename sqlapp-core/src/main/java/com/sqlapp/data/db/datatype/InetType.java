 ...
 *
 */
public class InetType extends AbstractNoSizeType<InetType>{
	 ...
	 */
	public InetType(){
		this(DataType.INET.getTypeName());
	}
	
	protected InetType(String dataTypeName){
		this.setDataType(DataType.INET);
