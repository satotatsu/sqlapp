...
public abstract class TypeBodyReader extends AbstractSchemaObjectReader<TypeBody>{

	protected TypeBodyReader(Dialect dialect) {
		super(dialect);
	}

	@Override
	protected SchemaObjectProperties getSchemaObjectProperties(){
		return SchemaObjectProperties.TYPE_BODIES;
	}
