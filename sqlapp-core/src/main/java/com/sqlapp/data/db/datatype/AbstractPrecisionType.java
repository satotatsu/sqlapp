...
public abstract class AbstractPrecisionType<T extends DbDataType<T>> extends DbDataType<T>
	...
	public T addColumnTypeMatcher(String typeName) {
		this.addColumnTypeMatcher(new PrecisionColumnTypeMatcher(typeName));
		return instance();
	}
	...
	public T setMaxPrecision(Integer maxPrecision) {
		...
		this.getParent().registerDataLength(this, Converters.getDefault().convertObject(maxPrecision, Long.class));
		return this.instance();
	}
