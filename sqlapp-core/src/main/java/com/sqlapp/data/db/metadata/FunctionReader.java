...
public abstract class FunctionReader extends RoutineReader<Function>{
	...
	protected FunctionReader(Dialect dialect) {
		super(dialect);
	}
	
	@Override
	protected SchemaObjectProperties getSchemaObjectProperties(){
		return SchemaObjectProperties.FUNCTIONS;
	}
	...
	protected String getNameLabel(){
		return DbObjects.FUNCTION.getCamelCaseNameLabel();
	}
