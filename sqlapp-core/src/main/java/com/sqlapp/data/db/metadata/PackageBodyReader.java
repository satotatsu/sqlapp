...
public abstract class PackageBodyReader extends AbstractSchemaObjectReader<PackageBody>{

	protected PackageBodyReader(Dialect dialect) {
		super(dialect);
	}

	@Override
	protected SchemaObjectProperties getSchemaObjectProperties(){
		return SchemaObjectProperties.PACKAGE_BODIES;
	}
	...
	protected String getNameLabel(){
		return DbObjects.PACKAGE.getCamelCaseNameLabel();
	}
