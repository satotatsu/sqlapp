 ...
 *
 */
public class MCharType extends AbstractLengthType<MCharType>{
	 ...
	 */
	public MCharType(){
		this(DataType.MCHAR.getTypeName());
	}
	
	protected MCharType(String dataTypeName){
		this.setDataType(DataType.MCHAR);
