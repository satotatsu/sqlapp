 ...
 *
 */
public class RowIdType extends AbstractNoSizeType<RowIdType>{
	 ...
	 */
	public RowIdType(){
		this(DataType.ROWID.getTypeName());
	}
	
	protected RowIdType(String dataTypeName){
		this.setDataType(DataType.ROWID);
		...
		this.setSystemInternalType(true);
