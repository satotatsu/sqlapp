...
public abstract class RuleReader extends AbstractSchemaObjectReader<Rule>{
	/**
	 * ルール名
	 */
	protected final static String RULE_NAME="rule_name";
	
	protected RuleReader(Dialect dialect) {
		super(dialect);
	}

	@Override
	protected SchemaObjectProperties getSchemaObjectProperties(){
		return SchemaObjectProperties.RULES;
	}
	...
	protected String getNameLabel(){
		return DbObjects.RULE.getCamelCaseNameLabel();
	}
