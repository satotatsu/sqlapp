...
/**
 * DROP PARTIONING生成クラス
 * 
 * @author satoh
 * 
 */
public abstract class AbstractDropPartitioningFactory<S extends AbstractSqlBuilder<?>>
	...
	public abstract void addObjectDetail(final Partitioning obj, S builder);
