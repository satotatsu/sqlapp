 ...
 *
 */
public class MoneyType extends AbstractNoSizeType<MoneyType>{
	 ...
	 * Byteのコンバータ
	 */
	protected BigDecimalConverter converter=new BigDecimalConverter();
	/**
	 * コンストラクタ
	 */
	public MoneyType(){
		this(DataType.MONEY.getTypeName());
	}
	
	protected MoneyType(String dataTypeName){
		this.setDataType(DataType.MONEY);
