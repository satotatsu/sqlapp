...
public abstract class ObjectPrivilegeReader extends AbstractCatalogObjectMetadataReader<ObjectPrivilege>{
	/**
	 * オブジェクト名
	 */
	...
	protected ObjectPrivilegeReader(Dialect dialect) {
		super(dialect);
	}

	@Override
	protected SchemaObjectProperties getSchemaObjectProperties(){
		return SchemaObjectProperties.OBJECT_PRIVILEGES;
	}
