...
public abstract class PackageReader extends AbstractSchemaObjectReader<Package>{

	protected PackageReader(Dialect dialect) {
		super(dialect);
	}

	@Override
	protected SchemaObjectProperties getSchemaObjectProperties(){
		return SchemaObjectProperties.PACKAGES;
	}
