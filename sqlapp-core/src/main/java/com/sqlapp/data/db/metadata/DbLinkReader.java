...
public abstract class DbLinkReader extends AbstractSchemaObjectReader<DbLink>{

	protected DbLinkReader(Dialect dialect) {
		super(dialect);
	}

	@Override
	protected SchemaObjectProperties getSchemaObjectProperties(){
		return SchemaObjectProperties.DB_LINKS;
	}
