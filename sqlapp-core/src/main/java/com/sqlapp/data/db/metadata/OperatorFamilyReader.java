...
public abstract class OperatorFamilyReader extends
		MetadataReader<OperatorFamily, OperatorClass> {
	/**
	 * Operatorクラス名
	 */
	 ...
	 */
	public OperatorFamilyReader setSchemaName(String schemaName) {
	...
	public void loadFull(Connection connection, OperatorClass target) {
		...
		List<OperatorFamily> list = getAll(connection, context);
		OperatorClassReader.addOperatorFamilies(list, target);
	}
