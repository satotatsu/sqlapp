...
public enum SchemaProperties implements ISchemaProperty {
	...
	DATA_TYPE_NAME() {
		...
		protected final boolean setValueInternal(final Object obj, final Object value) {
			if (obj instanceof AbstractColumn) {
				(AbstractColumn.class.cast(obj)).setDataTypeNameInternal(toString(value));
				return true;
			} else if (obj instanceof OperatorArgument) {
				(OperatorArgument.class.cast(obj)).setDataTypeNameInternal(toString(value));
				return true;
			} else if (obj instanceof OperatorBinding) {
				(OperatorBinding.class.cast(obj)).setDataTypeNameInternal(toString(value));
				return true;
			} else if (obj instanceof OperatorBindingArgument) {
				(OperatorBindingArgument.class.cast(obj)).setDataTypeNameInternal(toString(value));
				return true;
			} else if (obj instanceof OperatorClass) {
				(OperatorClass.class.cast(obj)).setDataTypeNameInternal(toString(value));
				return true;
			} else if (obj instanceof Sequence) {
				(Sequence.class.cast(obj)).setDataTypeNameInternal(toString(value));
				return true;
			} else if (obj instanceof PartitionFunction) {
				(PartitionFunction.class.cast(obj)).setDataTypeNameInternal(toString(value));
				return true;
			} else if (obj instanceof FunctionReturning) {
				(FunctionReturning.class.cast(obj)).setDataTypeNameInternal(toString(value));
				return true;
			}
			return false;
		}
		...
		public String getValue(final Object obj) {
			...
			if (obj instanceof AbstractColumn) {
				return (AbstractColumn.class.cast(obj)).getDataTypeNameInternal();
			} else if (obj instanceof OperatorArgument) {
				return (OperatorArgument.class.cast(obj)).getDataTypeNameInternal();
			} else if (obj instanceof OperatorBinding) {
				return (OperatorBinding.class.cast(obj)).getDataTypeNameInternal();
			} else if (obj instanceof OperatorBindingArgument) {
				return (OperatorBindingArgument.class.cast(obj)).getDataTypeNameInternal();
			} else if (obj instanceof OperatorClass) {
				return (OperatorClass.class.cast(obj)).getDataTypeNameInternal();
			} else if (obj instanceof Sequence) {
				return (Sequence.class.cast(obj)).getDataTypeNameInternal();
			} else if (obj instanceof PartitionFunction) {
				return (PartitionFunction.class.cast(obj)).getDataTypeNameInternal();
			} else if (obj instanceof FunctionReturning) {
				return (FunctionReturning.class.cast(obj)).getDataTypeNameInternal();
			}
			return null;
		}
	},
	...
	IDENTITY_GENERATION_TYPE() {
		...
		@Override
		protected final boolean setValueInternal(final Object obj, final Object value) {
			((IdentityGenerationTypeProperty<?>) obj)
					.setIdentityGenerationType(converters.convertObject(value, IdentityGenerationType.class));
			return true;
		}
	...
	PARTITIONING_TYPE() {
		...
		@Override
		protected final boolean setValueInternal(final Object obj, final Object value) {
			((PartitioningTypeProperty<?>) obj)
					.setPartitioningType(converters.convertObject(value, PartitioningType.class));
			return true;
		}
	...
	SUB_PARTITIONING_TYPE() {
		...
		@Override
		protected final boolean setValueInternal(final Object obj, final Object value) {
			((SubPartitioningTypeProperty<?>) obj)
					.setSubPartitioningType(converters.convertObject(value, PartitioningType.class));
			return true;
		}
	...
	PARTITION_FUNCTION_VALUES("values") {
		...
		protected final boolean setValueInternal(final Object obj, final Object value) {
			...
			if (value instanceof Collection) {
				...
				cst.getValues()
						.addAll(((Collection<?>) value).stream().map(c -> c.toString()).collect(Collectors.toList()));
				return true;
	...
	SUPPORT_NUMBER() {
		...
		@Override
		protected final boolean setValueInternal(final Object obj, final Object value) {
			((SupportNumberProperty<?>) obj)
					.setSupportNumber(converters.convertObject(value == null ? getDefaultValue() : value, int.class));
			return true;
		}
	...
	STRATEGY_NUMBER() {
		...
		@Override
		protected final boolean setValueInternal(final Object obj, final Object value) {
			((StrategyNumberProperty<?>) obj)
					.setStrategyNumber(converters.convertObject(value == null ? getDefaultValue() : value, int.class));
			return true;
		}
	...
	MAX_DYNAMIC_RESULT_SETS() {
		...
		@Override
		protected final boolean setValueInternal(final Object obj, final Object value) {
			((MaxDynamicResultSetsProperty<?>) obj)
					.setMaxDynamicResultSets(converters.convertObject(value, getValueClass()));
			return true;
		}
	...
	PRODUCT_MAJOR_VERSION() {
		...
		@Override
		protected final boolean setValueInternal(final Object obj, final Object value) {
			((ProductMajorVersionProperty<?>) obj)
					.setProductMajorVersion(converters.convertObject(value, getValueClass()));
			return true;
		}
	...
	PRODUCT_MINOR_VERSION() {
		...
		@Override
		protected final boolean setValueInternal(final Object obj, final Object value) {
			((ProductMinorVersionProperty<?>) obj)
					.setProductMinorVersion(converters.convertObject(value, getValueClass()));
			return true;
		}
	...
	DATA_SOURCE_ROW_NUMBER() {
		...
		@Override
		protected final boolean setValueInternal(final Object obj, final Object value) {
			((DataSourceRowNumberProperty<?>) obj)
					.setDataSourceRowNumber(converters.convertObject(value, getValueClass()));
			return true;
		}
	 ...
	 * 
	 * @see
	 * com.sqlapp.data.schemas.properties.ISchemaProperty#getGetterPropertyClass()
	 */
	@Override
	public Class<?> getGetterPropertyClass() {
		return null;
	 ...
	 * 
	 * @see
	 * com.sqlapp.data.schemas.properties.ISchemaProperty#getSetterPropertyClass()
	 */
	@Override
	public Class<?> getSetterPropertyClass() {
		return null;
	 ...
	 * 
	 * @see
	 * com.sqlapp.data.schemas.properties.ISchemaProperty#isGetterInstanceof(java.
	 * lang.Object)
	 */
	@Override
	public boolean isGetterInstanceof(final Object obj) {
	 ...
	 * 
	 * @see
	 * com.sqlapp.data.schemas.properties.ISchemaProperty#isSetterInstanceof(java.
	 * lang.Object)
	 */
	@Override
	public boolean isSetterInstanceof(final Object obj) {
	 ...
	 * 
	 * @see
	 * com.sqlapp.data.schemas.properties.ISchemaProperty#isInstanceof(java.lang.
	 * Object)
	 */
	@Override
	public boolean isInstanceof(final Object obj) {
	 ...
	 * 
	 * @see
	 * com.sqlapp.data.schemas.properties.ISchemaProperty#isValueInstanceof(java.
	 * lang.Object)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.sqlapp.data.schemas.properties.ISchemaProperty#setValue(java.lang.Object,
	 * java.lang.Object)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.sqlapp.data.schemas.properties.ISchemaProperty#isEnabled(java.lang.
	 * Object)
	 */
	@Override
	public boolean isEnabled(final Object obj) {
	 ...
	 * 
	 * @see
	 * com.sqlapp.data.schemas.properties.ISchemaProperty#getValue(java.lang.Object)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.sqlapp.data.schemas.properties.ISchemaProperty#getCloneValue(java.lang.
	 * Object)
	 */
	@Override
