 ...
 *
 */
public final class Lseg extends AbstractMultiPoint<Point> implements ToUpperDimensionType<Lseg3D>{
	 ...
	 */
	public Line toLine(){
		Line line=new Line(this.getPoints()[0].clone(), this.getPoints()[1].clone());
		return line;
	}
	 ...
	 */
	public Box toBox(){
		Box box=new Box(this.getPoints()[0].clone(), this.getPoints()[1].clone());
		return box;
	}
