...
public class SqlappParserContextFactory {

	private static final SqlappParserContextFactory instance = new SqlappParserContextFactory();

	static {
		OptimizerFactory.setDefaultOptimizer(OptimizerFactory.SAFE_REFLECTIVE);
	}

	public static SqlappParserContextFactory getInstance() {
		return instance;
	}
