 ...
 * 
 */
public class ListHandler extends AbstractCollectionHandler<List<String>> {

	@Override
	public String getLocalName() {
		return StaxWriter.LIST_ELEMENT;
	}
	...
	protected void doCallback(StaxReader reader, StaxElementHandler child,
		...
		List<String> result = cast(parentObject);
		result.add((String) value);
	}

	@Override
	protected List<String> createNewInstance() {
		return list();
	}
}
