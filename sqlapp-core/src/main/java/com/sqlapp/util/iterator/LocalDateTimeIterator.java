...
final class LocalDateTimeIterator extends AbstractObjectIterator<LocalDateTime, Integer>{
	 ...
	 * @param end
	 */
	public LocalDateTimeIterator(final LocalDateTime start, final LocalDateTime end){
	 ...
	 * @param step ステップ(秒単位)
	 */
	public LocalDateTimeIterator(final LocalDateTime start, final LocalDateTime end, final Integer step){
	...
	public LocalDateTimeIterator clone(){
		LocalDateTimeIterator clone=new LocalDateTimeIterator(this.start, this.end, this.step);
		return clone;
	}
}
