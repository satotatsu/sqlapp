...
final class ZonedDateTimeIntervalIterator extends AbstractObjectIterator<ZonedDateTime, Interval>{
	 ...
	 * @param step ステップ
	 */
	public ZonedDateTimeIntervalIterator(final ZonedDateTime start, final ZonedDateTime end, final Interval step){
	...
	public ZonedDateTimeIntervalIterator clone(){
		ZonedDateTimeIntervalIterator clone=new ZonedDateTimeIntervalIterator(this.start, this.end, this.step);
		return clone;
	}
}
