 ...
 */
@FunctionalInterface
public interface SQLTriConsumer<S, T, U> {
	/**
	 ...
	 */
	void accept(S s, T t, U u) throws SQLException;
	 ...
	 */
	default SQLTriConsumer<S, T, U> andThen(SQLTriConsumer<? super S, ? super T, ? super U> after) {
	 ...
	 * @throws NullPointerException if {@code after} is null
	 */
	default SQLTriConsumer<S, T, U> andThen(TriConsumer<? super S, ? super T, ? super U> after) {
		Objects.requireNonNull(after);
		return (l, r, u) -> {
			accept(l, r, u);
			after.accept(l, r, u);
