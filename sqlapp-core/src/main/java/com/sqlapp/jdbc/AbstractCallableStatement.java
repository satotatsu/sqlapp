 ...
 * @param <T>
 */
public abstract class AbstractCallableStatement<T extends CallableStatement> extends AbstractPreparedStatement<T>
		implements CallableStatement {

	public AbstractCallableStatement(final T nativeObject, final String sql, final SqlappConnection connection) {
	 ...
	 */
	@Override
	public <TT> TT getObject(final int parameterIndex, final Class<TT> type) throws SQLException {
	 ...
	 */
	@Override
	public <TT> TT getObject(final String parameterName, final Class<TT> type) throws SQLException {
	...
	public void setObject(final String parameterName, final Object x, final java.sql.SQLType targetSqlType)
			throws SQLException {
		nativeObject.setObject(parameterName, x, targetSqlType);
	}

	@Override
	public void registerOutParameter(final int parameterIndex, final java.sql.SQLType sqlType) throws SQLException {
		nativeObject.registerOutParameter(parameterIndex, sqlType);
	}

	@Override
	public void registerOutParameter(final int parameterIndex, final java.sql.SQLType sqlType, final int scale)
			throws SQLException {
		nativeObject.registerOutParameter(parameterIndex, sqlType, scale);
	}

	@Override
	public void registerOutParameter(final int parameterIndex, final java.sql.SQLType sqlType, final String typeName)
			throws SQLException {
		nativeObject.registerOutParameter(parameterIndex, sqlType, typeName);
	}

	@Override
	public void registerOutParameter(final String parameterName, final java.sql.SQLType sqlType) throws SQLException {
		nativeObject.registerOutParameter(parameterName, sqlType);
	}

	@Override
	public void registerOutParameter(final String parameterName, final java.sql.SQLType sqlType, final int scale)
			throws SQLException {
		nativeObject.registerOutParameter(parameterName, sqlType, scale);
	}

	@Override
	public void registerOutParameter(final String parameterName, final java.sql.SQLType sqlType, final String typeName)
			throws SQLException {
		nativeObject.registerOutParameter(parameterName, sqlType, typeName);
	}
