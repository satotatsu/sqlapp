...
public class TomlIterable extends AbstractTextMapIterable {

	public TomlIterable(File file) {
		super(file);
	}

	public TomlIterable(Path path) {
		super(path);
	}

	public TomlIterable(InputStream inputStream) {
		super(inputStream);
	}

	public TomlIterable(Reader reader) {
		super(reader);
	}

	public ObjectReader getObjectReader() {
		return WorkbookFileType.TOML.getObjectReader();
	}
