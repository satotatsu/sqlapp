...
public class CsvIterable extends AbstractTextMapIterable {

	public CsvIterable(File file) {
		super(file);
	}

	public CsvIterable(Path path) {
		super(path);
	}

	public CsvIterable(InputStream inputStream) {
		super(inputStream);
	}

	public CsvIterable(Reader reader) {
		super(reader);
	}

	public ObjectReader getObjectReader() {
		return WorkbookFileType.CSV.getObjectReader();
	}
