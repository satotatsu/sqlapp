...
public class JsonConverterTest extends AbstractTest {
	...
	public void testToJsonStringDate() throws ParseException {
		...
		final String val = converter.toJsonString(dummy1).replace("\r\n", "\n");
		System.out.println(val);
		final Dummy dummy2 = converter.fromJsonString(val, Dummy.class);
		assertEquals(dummy1, dummy2);
		final String expected = FileUtils.getResource(this, "jsonConverter1.txt");
