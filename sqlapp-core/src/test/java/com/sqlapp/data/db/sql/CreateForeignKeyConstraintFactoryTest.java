...
public class CreateForeignKeyConstraintFactoryTest extends AbstractStandardFactoryTest {
	SqlFactory<ForeignKeyConstraint> operationfactory;

	@BeforeEach
	public void before() {
		operationfactory = sqlFactoryRegistry.getSqlFactory(new ForeignKeyConstraint(), State.Added);
	}
	...
	public void testGetDdlTable() {
		...
		ForeignKeyConstraint fk = table.getConstraints()
		...
		String expected = FileUtils.getResource(this, "create_fk1.sql");
