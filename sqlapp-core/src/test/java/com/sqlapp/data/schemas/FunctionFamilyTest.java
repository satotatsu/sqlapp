...
public class FunctionFamilyTest extends AbstractDbObjectTest<FunctionFamily>{
	...
	@Override
	protected FunctionFamily getObject() {
		return getFunctionFamily("functionA");
	}

	@Override
	protected AbstractBaseDbObjectXmlReaderHandler<FunctionFamily> getHandler() {
		return getObject().getDbObjectXmlReaderHandler();
	}

	@Override
	protected void testDiffString(FunctionFamily obj1, FunctionFamily obj2) {
		obj2.setFunctionName("functionB");
