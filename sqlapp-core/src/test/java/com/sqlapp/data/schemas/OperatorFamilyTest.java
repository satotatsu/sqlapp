...
public class OperatorFamilyTest extends AbstractDbObjectTest<OperatorFamily>{
	...
	@Override
	protected OperatorFamily getObject() {
		return getOperatorFamily("operatorA");
	}

	@Override
	protected AbstractBaseDbObjectXmlReaderHandler<OperatorFamily> getHandler() {
		return getObject().getDbObjectXmlReaderHandler();
	}

	@Override
	protected void testDiffString(OperatorFamily obj1, OperatorFamily obj2) {
		obj2.setOperatorName("operatorB");
