...
public class UserPrivilegeTest extends AbstractDbObjectTest<UserPrivilege>{
	...
	@Override
	protected UserPrivilege getObject() {
		return getPrivilege();
	}

	@Override
	protected AbstractBaseDbObjectXmlReaderHandler<UserPrivilege> getHandler() {
		return getObject().getDbObjectXmlReaderHandler();
	}

	@Override
	protected void testDiffString(UserPrivilege obj1, UserPrivilege obj2) {
