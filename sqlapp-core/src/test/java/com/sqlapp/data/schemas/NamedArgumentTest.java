...
public class NamedArgumentTest extends AbstractDbObjectTest<NamedArgument>{
	...
	@Override
	protected AbstractNamedObjectXmlReaderHandler<NamedArgument> getHandler() {
		return getObject().getDbObjectXmlReaderHandler();
	}

	@Override
	protected void testDiffString(NamedArgument obj1, NamedArgument obj2) {
		obj2.setName("b");
		obj2.setRemarks("commentB");
