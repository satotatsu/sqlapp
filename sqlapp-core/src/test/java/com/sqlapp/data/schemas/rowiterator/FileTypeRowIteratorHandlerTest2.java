...
public class FileTypeRowIteratorHandlerTest2 extends AbstractRowIteratorHandlerTest{

	@Override
	protected RowIteratorHandler getRowIteratorHandler() {
		return new FileTypeRowIteratorHandler(new File("src/test/resources/testWithoutHeader.csv"), "UTF8", 0);
	}
