...
class MigrationInsertTaskTest extends AbstractTaskTest{
	...
	public void canAddTaskToProject() {
		...
		MigrationInsertTask task =project.tasks.register('migrationInsert', MigrationInsertTask).get()
		assertTrue(task instanceof MigrationInsertTask)
		task.exec()
	}
}
