 ...
 * 
 */
public class PostgresDefragTableSqlFactoryTest extends AbstractPostgresSqlFactoryTest {
	...
	public void before() {
		...
		operation = this.sqlFactoryRegistry.getSqlFactory(new Table(), SqlType.DEFRAG);
	}
	...
	public void testGetDdlTableTable1() {
		...
		String expected = getResource("defrag_table1.sql");
