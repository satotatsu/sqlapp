...
public class PostgresAlterTableFactory extends AbstractAlterTableFactory<PostgresSqlBuilder> {
	...
	protected void addPropertiesDefinitions(Map<String, Difference<?>> allDiff, Table originalTable, Table table,
			List<SqlOperation> result) {
	...
	protected void addCommentDefinitions(Map<String, Difference<?>> allDiff, Table originalTable, Table table,
			List<SqlOperation> result) {
