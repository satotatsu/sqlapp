...
/**
 * PostgresのSettingReader
 * 
 * @author satoh
 * 
 */
public class PostgresSettingReader extends SettingReader {

	protected PostgresSettingReader(final Dialect dialect) {
		super(dialect);
	}
	...
	protected Setting createSetting(ExResultSet rs) throws SQLException {
		...
		obj.setValue(getString(rs, "setting"));
		obj.setRemarks(getString(rs, "short_desc"));
		return obj;
	}
}
