...
module com.sqlapp.core.symfoware {
	requires java.xml;
	requires java.sql;
	requires com.sqlapp.core;
	exports com.sqlapp.data.db.dialect.symfoware;
	exports com.sqlapp.data.db.dialect.symfoware.metadata;
	exports com.sqlapp.data.db.dialect.symfoware.resolver;
}