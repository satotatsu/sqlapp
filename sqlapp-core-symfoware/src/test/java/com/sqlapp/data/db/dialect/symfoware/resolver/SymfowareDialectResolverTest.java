...
import com.sqlapp.data.db.dialect.symfoware.resolver.SymfowareDialectResolver;

public class SymfowareDialectResolverTest {

	private SymfowareDialectResolver resolver=new SymfowareDialectResolver();
	
	@Test
	public void testGetDialectStringIntInt() {
		assertEquals("Symfoware",resolver.getDialect("Symfoware", 0, 0).getProductName());
	}
