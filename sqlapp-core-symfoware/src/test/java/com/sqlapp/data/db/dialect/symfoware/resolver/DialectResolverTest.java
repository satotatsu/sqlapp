...
public class DialectResolverTest {
	...
	public void testGetDialect() {
		Dialect dialect = DialectResolver.getInstance().getDialect("Symfoware", 0, 0, 0);
		System.out.println(dialect);
		assertTrue(dialect instanceof Symfoware);
	}
	...
	public void testServiceLoader() {
		...
		for (ProductNameDialectResolver resolver : loader) {
			if (resolver instanceof SymfowareDialectResolver) {
				find = true;
			}
		}
		assertTrue(find);
