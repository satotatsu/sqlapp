 ...
 * 
 */
public class SpannerTruncateTemporaryTableFactory extends AbstractTruncateTemporaryTableFactory<SpannerSqlBuilder> {

	@Override
	protected void addTruncateTable(final Table obj, final SpannerSqlBuilder builder) {
