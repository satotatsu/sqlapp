 ...
 * 
 */
public class SpannerCreateTemporaryTableFactory extends AbstractCreateTemporaryTableFactory<SpannerSqlBuilder> {

	@Override
	protected void addCreateObject(final Table obj, final SpannerSqlBuilder builder) {
