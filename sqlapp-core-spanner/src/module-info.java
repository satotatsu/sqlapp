...
module com.sqlapp.core.spanner {
	requires java.xml;
	requires java.sql;
	requires com.sqlapp.core;
	exports com.sqlapp.data.db.dialect.spanner;
	exports com.sqlapp.data.db.dialect.spanner.metadata;
	exports com.sqlapp.data.db.dialect.spanner.resolver;
}