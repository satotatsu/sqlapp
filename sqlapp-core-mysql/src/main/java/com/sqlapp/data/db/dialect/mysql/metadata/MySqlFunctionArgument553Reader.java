...
public class MySqlFunctionArgument553Reader extends MySqlFunctionArgumentReader {

	protected MySqlFunctionArgument553Reader(Dialect dialect) {
		super(dialect);
	}
	...
	protected SqlNode getSqlSqlNode(ProductVersionInfo productVersionInfo) {
		if (productVersionInfo.gte(5, 5, 3)) {
			return getSqlNodeCache().getString("functionArguments553.sql");
		} else {
