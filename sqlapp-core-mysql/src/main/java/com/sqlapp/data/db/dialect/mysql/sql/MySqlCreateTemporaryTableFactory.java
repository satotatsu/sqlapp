 ...
 * 
 */
public class MySqlCreateTemporaryTableFactory extends AbstractCreateTemporaryTableFactory<MySqlSqlBuilder> {

	@Override
	protected void addCreateObject(final Table obj, final MySqlSqlBuilder builder) {
	 ...
	 */
	@Override
	protected void addOption(final Table table, final MySqlSqlBuilder builder) {
	}
}
