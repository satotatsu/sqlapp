 ...
 * 
 */
public class MySqlSettingReader extends SettingReader {

	protected MySqlSettingReader(final Dialect dialect) {
		super(dialect);
	}
	...
	protected Setting createSetting(ExResultSet rs) throws SQLException {
		Setting obj = new Setting(getString(rs, "variable_name"));
		obj.setValue(getString(rs, "variable_value"));
		return obj;
	}
}
