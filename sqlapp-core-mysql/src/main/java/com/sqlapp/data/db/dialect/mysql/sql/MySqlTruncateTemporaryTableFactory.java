 ...
 * 
 */
public class MySqlTruncateTemporaryTableFactory extends AbstractTruncateTemporaryTableFactory<MySqlSqlBuilder> {

	@Override
	protected void addTruncateTable(final Table obj, final MySqlSqlBuilder builder) {
