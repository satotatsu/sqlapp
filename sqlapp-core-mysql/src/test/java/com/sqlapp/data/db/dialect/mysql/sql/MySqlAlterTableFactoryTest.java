...
public class MySqlAlterTableFactoryTest extends AbstractMySqlSqlFactoryTest {
	...
	public void testForeinfKey() {
		...
		ForeignKeyConstraint fk = table2.getConstraints().addForeignKeyConstraint("tableA_tableb_fk",
	...
	public void testForeinfKey2() {
		...
		table2.getConstraints().addForeignKeyConstraint("tableA_tableb_fk",
				new Column[] { table2.getColumns().get("colb") }, new Column[] { table3.getColumns().get("cola1") });
