...
/** SAP ASE local-temporary-table SCD2 flow. */
public final class SybaseSetBasedMigrationSnapshotExecutor extends AbstractStagingMigrationSnapshotExecutor {
	public SybaseSetBasedMigrationSnapshotExecutor(final Dialect dialect) {
		super(dialect);
	}
