...
public class HsqlCreateTemporaryTableFactoryTest extends AbstractHsql2_1_0SqlFactoryTest {

	SqlFactory<Table> sqlFactory;

	@BeforeEach
	public void before() {
		sqlFactory = sqlFactoryRegistry.getSqlFactory(new Table(), SqlType.CREATE_TEMPORARY);
	}
