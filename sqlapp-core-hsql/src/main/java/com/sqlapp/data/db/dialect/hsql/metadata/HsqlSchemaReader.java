 ...
 * 
 */
public class HsqlSchemaReader extends AbstractISSchemaReader {

	protected HsqlSchemaReader(Dialect dialect) {
		super(dialect);
	}
	...
	protected TableReader newTableReader() {
		return new HsqlTableReader(this.getDialect());
	}

	@Override
	protected ViewReader newViewReader() {
		return new HsqlViewReader(this.getDialect());
	}
	...
	protected SequenceReader newSequenceReader() {
		return new HsqlSequenceReader(this.getDialect());
	}
	...
	protected DomainReader newDomainReader() {
		return new HsqlDomainReader(this.getDialect());
	}
	...
	protected FunctionReader newFunctionReader() {
		return new HsqlFunctionReader(this.getDialect());
	}

	@Override
	protected ProcedureReader newProcedureReader() {
		return new HsqlProcedureReader(this.getDialect());
	}
	...
	protected TriggerReader newTriggerReader() {
		return new HsqlTriggerReader(this.getDialect());
	}
