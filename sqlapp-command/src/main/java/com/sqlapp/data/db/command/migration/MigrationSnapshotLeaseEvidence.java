...
public record MigrationSnapshotLeaseEvidence(BulkMigrationJobLeaseMode mode, String ownerId, Duration duration,
	...
	public MigrationSnapshotLeaseEvidence {
		if (mode == null || ownerId == null || ownerId.isBlank() || duration == null || duration.isZero()
				|| duration.isNegative()) {
		...
		if (mode == BulkMigrationJobLeaseMode.FILE && (directory == null || directory.isBlank() || tableName != null)) {
