...
class JdbcBatchTreeUpsertHandlerIdentityTest extends AbstractDbCommandTest {
	...
	void testInsertUpdateWithGeneratedKey() throws SQLException {
		test(connection -> {
			...
			JdbcBatchTreeUpsertHandler handler = new JdbcBatchTreeUpsertHandler(connection, tableRelationTreeHolder);
