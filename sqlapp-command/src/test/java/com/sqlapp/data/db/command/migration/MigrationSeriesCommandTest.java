...
public class MigrationSeriesCommandTest extends AbstractVersionUpCommandTest {
	@Override
	@Test
	public void testRun() throws ParseException, IOException, SQLException {
		...
		testVersionUp(handler, (times, ds) -> {
			try {
				...
				final MigrationSeriesDownCommand versionDownCommand = new MigrationSeriesDownCommand();
