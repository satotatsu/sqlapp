...
import com.sqlapp.data.db.command.migration.MigrationDeleteCommand;
...
public class MigrationInsertCommandTest extends AbstractVersionUpCommandTest {
	...
	protected MigrationCommand createVersionUpCommand() {
		return new MigrationInsertCommand();
	}
