 ...
 * 
 */
public class SqliteTruncateTemporaryTableFactoryTest extends SqliteSqlFactoryTest {
	SqlFactory<Table> operation;

	@BeforeEach
	public void before() {
		operation = this.sqlFactoryRegistry.getSqlFactory(new Table(), SqlType.TRUNCATE_TEMPORARY);
	}
