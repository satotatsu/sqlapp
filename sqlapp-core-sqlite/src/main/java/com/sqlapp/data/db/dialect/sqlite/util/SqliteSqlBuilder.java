 ...
 * 
 */
public class SqliteSqlBuilder extends AbstractSqlBuilder<SqliteSqlBuilder> {

	public SqliteSqlBuilder(Dialect dialect) {
		super(dialect);
	}
	...
	@Override
	public SqliteSqlBuilder clone() {
		return (SqliteSqlBuilder) super.clone();
	}
