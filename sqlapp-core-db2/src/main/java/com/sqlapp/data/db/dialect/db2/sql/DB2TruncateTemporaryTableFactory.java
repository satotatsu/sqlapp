 ...
 * 
 */
public class DB2TruncateTemporaryTableFactory extends AbstractTruncateTemporaryTableFactory<Db2SqlBuilder> {

	@Override
	protected void addTruncateTable(final Table obj, final Db2SqlBuilder builder) {
