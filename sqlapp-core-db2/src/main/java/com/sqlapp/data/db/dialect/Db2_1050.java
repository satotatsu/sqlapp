...
import com.sqlapp.data.db.dialect.db2.metadata.Db2_1050CatalogReader;
import com.sqlapp.data.db.dialect.db2.sql.Db2_1050SqlFactoryRegistry;
 ...
 * 
 */
public class Db2_1050 extends Db2_1010 {
	/**
	 * serialVersionUID
	 */
	 ...
	 */
	public Db2_1050(Supplier<Dialect> nextVersionDialectSupplier) {
	...
	public CatalogReader getCatalogReader() {
		return new Db2_1050CatalogReader(this);
	}
