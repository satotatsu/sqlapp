...
public class CreateTemporaryTableFactoryTest extends AbstractH2SqlFactoryTest {
	SqlFactory<Table> command;

	@BeforeEach
	public void before() {
		command = this.sqlFactoryRegistry.getSqlFactory(new Table("tabA"), SqlType.CREATE_TEMPORARY);
	}
	...
	public void testGetDdl() {
		...
		String expected = """
				DECLARE LOCAL TEMPORARY TABLE [tableA]
				(
					  [colA] INTEGER NOT NULL
					, [colB] BIGINT NOT NULL CHECK (colB>0)
					, [colC] VARCHAR(10) DEFAULT 0
