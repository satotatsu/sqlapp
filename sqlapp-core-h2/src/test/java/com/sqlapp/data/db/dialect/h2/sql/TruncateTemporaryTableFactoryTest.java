...
public class TruncateTemporaryTableFactoryTest extends AbstractH2SqlFactoryTest {
	SqlFactory<Table> command;

	@BeforeEach
	public void before() {
		command = this.sqlFactoryRegistry.getSqlFactory(new Table("tabA"), SqlType.TRUNCATE_TEMPORARY);
	}
