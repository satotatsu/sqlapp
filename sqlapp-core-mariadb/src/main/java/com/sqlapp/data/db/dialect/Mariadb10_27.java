...
import com.sqlapp.data.db.dialect.mariadb.metadata.MariadbCatalog10_27Reader;
 ...
 * 
 */
public class Mariadb10_27 extends Mariadb10_25 {
	/**
	 * serialVersionUID
	 */
	private static final long serialVersionUID = -3303539585921104825L;

	protected Mariadb10_27(Supplier<Dialect> nextVersionDialectSupplier) {
	...
	public CatalogReader getCatalogReader() {
		return new MariadbCatalog10_27Reader(this);
	}
