...
public class SqlServer2005TruncateTemporaryTableFactoryTest extends AbstractSqlServer11SqlFactoryTest {
	SqlFactory<Table> operationfactory;

	@BeforeEach
	public void before() {
		operationfactory = sqlFactoryRegistry.getSqlFactory(new Table(), SqlType.TRUNCATE_TEMPORARY);
	}
