...
public class SqlServerCreateViewTest extends AbstractSqlServerSqlFactoryTest {
	SqlFactory<View> createOperationFactory;
	...
	private View get(String name) {
		View obj = new View(name);
		obj.setDialect(dialect);
		obj.setStatement("SELECT * FROM TBL1");
		return obj;
	}

	@Test
	public void testCreateTest1() {
		View obj = get("ISOweek");
		String statement = getResource("create_view_statement1.sql");
		...
		String expected = getResource("create_view1.sql");
