...
public class DialectResolverTest {
	...
	public void testGetDialect() {
		Dialect dialect = DialectResolver.getInstance().getDialect("Microsoft SQL Server", 0, 0, 0);
		System.out.println(dialect);
		assertTrue(dialect instanceof SqlServer2000);
	}
	...
	public void testServiceLoader() {
		...
		for (ProductNameDialectResolver resolver : loader) {
			if (resolver instanceof SqlServerDialectResolver) {
				find = true;
			}
		}
		assertTrue(find);
