...
public class SqlServer2012CreateSequenceFactoryTest extends AbstractSqlServer12SqlFactoryTest {
	SqlFactory<Sequence> operationfactory;

	@BeforeEach
	public void before() {
		operationfactory = sqlFactoryRegistry.getSqlFactory(new Sequence(), SqlType.CREATE);
	}
