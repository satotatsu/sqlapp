...
public class SqlServer2022SequenceNextValuesFactoryTest extends AbstractSqlServer2022SqlFactoryTest {
	SqlFactory<Sequence> operationfactory;

	@BeforeEach
	public void before() {
		sqlFactoryRegistry.registerSqlFactory(SqlType.SEQUENCE_NEXT_VALUES,
