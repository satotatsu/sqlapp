...
/**
 * SQLServer2005用のTEMPテーブル作成
 * 
 * @author tatsuo satoh
 * 
 */
public class SqlServer2005CreateTemporaryTableFactory extends AbstractCreateTemporaryTableFactory<SqlServerSqlBuilder> {

	@Override
	protected void addCreateObject(final Table obj, final SqlServerSqlBuilder builder) {
