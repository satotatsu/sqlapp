...
public final class SqlServerSetBasedMigrationSnapshotExecutor extends AbstractStagingMigrationSnapshotExecutor {
	public SqlServerSetBasedMigrationSnapshotExecutor(final Dialect dialect) { super(dialect); }
	...
	@Override protected String updateTarget(final String target) { return "UPDATE t"; }
	@Override protected String updateFrom(final String target) { return " FROM " + target + " t"; }
