...
public class SqlServer2005ProcedureArgumentReader extends RoutineArgumentReader<Procedure> {

	protected SqlServer2005ProcedureArgumentReader(Dialect dialect) {
		super(dialect);
	}
