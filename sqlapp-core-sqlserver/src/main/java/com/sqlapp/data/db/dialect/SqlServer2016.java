...
import com.sqlapp.data.db.dialect.sqlserver.metadata.SqlServer2016CatalogReader;
import com.sqlapp.data.db.dialect.sqlserver.sql.SqlServer2016SqlFactoryRegistry;
...
public class SqlServer2016 extends SqlServer2014 {
	...
	public CatalogReader getCatalogReader() {
		return new SqlServer2016CatalogReader(this);
	}
