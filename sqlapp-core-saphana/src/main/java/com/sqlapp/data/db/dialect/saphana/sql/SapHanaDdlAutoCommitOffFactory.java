...
import com.sqlapp.data.db.sql.AbstractDdlAutoCommitOffFactory;

public class SapHanaDdlAutoCommitOffFactory extends AbstractDdlAutoCommitOffFactory<SapHanaSqlBuilder> {
