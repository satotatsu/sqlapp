...
public class SapHanaViewReader extends ViewReader {

	protected SapHanaViewReader(Dialect dialect) {
		super(dialect);
	}
	...
	protected Table createTable(ExResultSet rs) throws SQLException {
		Table table = super.createTable(getString(rs, VIEW_NAME));
		table.setId("" + rs.getLong("VIEW_OID"));
		table.setSchemaName(getString(rs, SCHEMA_NAME));
		table.setRemarks(getString(rs, "COMMENTS"));
		table.setDefinition(getString(rs, "DEFINITION"));
		return table;
	}
