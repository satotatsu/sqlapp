 ...
 * 
 */
public class SapHanaTruncateTemporaryTableFactory extends AbstractTruncateTemporaryTableFactory<SapHanaSqlBuilder> {

	protected void addTruncateTable(final Table obj, final SapHanaSqlBuilder builder) {
