 ...
 * 
 */
public class SapHahaCreateTemporaryTableFactory extends AbstractCreateTemporaryTableFactory<SapHanaSqlBuilder> {
	 ...
	 */
	@Override
	protected void addOption(final Table table, final SapHanaSqlBuilder builder) {
	}
}
