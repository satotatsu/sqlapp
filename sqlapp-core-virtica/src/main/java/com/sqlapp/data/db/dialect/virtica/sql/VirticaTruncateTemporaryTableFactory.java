 ...
 * 
 */
public class VirticaTruncateTemporaryTableFactory extends AbstractTruncateTemporaryTableFactory<VirticaSqlBuilder> {

	@Override
	protected void addTruncateTable(final Table obj, final VirticaSqlBuilder builder) {
		// TRUNCATEするとCOMMITされるのでDELETEに差し替える
