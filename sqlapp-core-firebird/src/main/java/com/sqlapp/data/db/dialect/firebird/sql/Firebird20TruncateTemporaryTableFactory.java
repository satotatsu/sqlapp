 ...
 * 
 */
public class Firebird20TruncateTemporaryTableFactory extends AbstractTruncateTemporaryTableFactory<FirebirdSqlBuilder> {

	@Override
	protected void addTruncateTable(final Table obj, final FirebirdSqlBuilder builder) {
