...
import com.sqlapp.data.db.dialect.firebird.metadata.Firebird20CatalogReader;
import com.sqlapp.data.db.dialect.firebird.sql.Firebird20SqlFactoryRegistry;
 ...
 * 
 */
public class Firebird20 extends Firebird {

	protected Firebird20(final Supplier<Dialect> nextVersionDialectSupplier) {
	...
	public CatalogReader getCatalogReader() {
		return new Firebird20CatalogReader(this);
	}
